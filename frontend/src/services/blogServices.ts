...
// ----------------------------------------------------------------------------------
  static changeVisibility = async (blogId: string) => {
    const response = await api.put(`blogs/blog/${blogId}/visibility/`, {}, {});

    return response.data;
  };

  static makeTrue = async (blogId: string) => {
    const response = await api.put(`blogs/blog/${blogId}/makeTrue/`, {}, {});

    return response.data;
  };
  static makeFalse = async (blogId: string) => {
    const response = await api.put(`blogs/blog/${blogId}/makeFalse/`, {}, {});
